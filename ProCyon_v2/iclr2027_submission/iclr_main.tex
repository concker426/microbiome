...
Following the analysis protocol of BiomeGPT~\citep{biomegpt2026}, we examine whether LOO attribution is driven by univariate differential abundance. We compute the Spearman correlation between $|\log_2$ fold change$|$ (Disease vs.\ Healthy mean abundance) and mean LOO importance:
