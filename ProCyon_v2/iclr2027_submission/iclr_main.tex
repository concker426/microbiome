...
A minimal ablation program augments SimpleEmb: rank-bin (A1), abundance-bin (A2), gated pooling (A3), masked-abundance pretraining (A4), A3+A4 (A5), token dropout (A6), and a linear head (A8). A module is retained only if it improves AUROC/AUPRC with non-overlapping 95\% CIs in $\geq$10 of 15 folds and transfers to a low-data or external setting. The final model is provisionally named SimpleEmb-MAP.
