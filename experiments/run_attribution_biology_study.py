...
ax.set_xticklabels([n[0].upper()+n[1:] if n else n for n in top30_names], rotation=90, fontsize=7)
ax.set_yticklabels([n[0].upper()+n[1:] if n else n for n in top30_names], fontsize=6)
ax.set_title('Genus Embedding Cosine Similarity (Top-30 LOO-important genera)', fontweight='bold')
plt.colorbar(im, ax=ax, shrink=0.8)
fig.subplots_adjust(left=0.28, right=0.92, top=0.93, bottom=0.25)
