...
OUT = ROOT / "experiments/results/decontaminated_groupcv_classical_no_xgboost_20260804"
VOCAB_SIZE = 1226
SEEDS = [42, 123, 456]
...
def main() -> None:
    ...
    manifest = {
        "experiment": "decontaminated_groupcv_classical_no_xgboost_20260804",
        ...
        "seeds": SEEDS,
        "models": list(models),
        "note": "Fixed baseline hyperparameters; this is leakage-robust comparison, not nested-CV hyperparameter optimization. XGBoost is intentionally absent because it is not installed in the isolated Python 3.11 environment.",
